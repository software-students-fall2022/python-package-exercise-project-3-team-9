...
class Tests:
    def test_verify_very_strong(self):
        ...
        assert passwordpack.verify_type(
            passwordpack.verify_pass(password), len(password))
